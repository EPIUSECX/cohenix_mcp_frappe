# Master Control Plan: `Customize Form`
...
| `doc_type` | Enter Form Type | Link | DocType |  |  |  | None | None |
| `properties` | None | Section Break | None |  |  |  | None | None |
| `label` | Change Label (via Custom Translation) | Data | None |  |  |  | None | None |
| `search_fields` | Search Fields | Data | None |  |  |  | None | Fields separated by comma (,) will be included in the "Search By" list of Search dialog box |
| `grid_page_length` | Grid Page Length | Int | None |  |  |  | None | None |
| `link_filters` | Link Filters | JSON | None |  | ✅ |  | None | None |
| `column_break_5` | None | Column Break | None |  |  |  | None | None |
| `istable` | Is Table | Check | None |  |  | ✅ | 0 | None |
| `is_calendar_and_gantt` | Is Calendar and Gantt | Check | None |  |  |  | 0 | Enables Calendar and Gantt views. |
| `editable_grid` | Editable Grid | Check | None |  |  |  | 0 | None |
| `quick_entry` | Quick Entry | Check | None |  |  |  | 1 | None |
| `track_changes` | Track Changes | Check | None |  |  |  | 0 | None |
| `track_views` | Track Views | Check | None |  |  |  | 0 | None |
...
Random
By script |  |  |  | None | None |
| `autoname` | Auto Name | Data | None |  |  |  | None | Naming Options:
...
| `states` | States | Table | DocType State |  |  |  | None | None |
