# Master Control Plan: `Log Settings`
...
|---|---|---|---|---|---|---|---|---|
| `logs_to_clear` | Logs to Clear | Table | Logs To Clear |  |  |  | None | None |
...
### File-Based Script
**Path:** `/workspace/cohenix-bench/apps/frappe/frappe/core/doctype/log_settings/log_settings.js`
```javascript
