# Master Control Plan: `Work Order`
...
| `serial_no_and_batch_for_finished_good_section` | Finished Good Serial / Batch | Section Break | None |  |  |  | None | None |
...
| `Work Orders in Progress` | Query Report | Manufacturing |
